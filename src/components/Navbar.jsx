...
export default function Navbar({ onOpenBooking }) {
  ...
  return (
    <>
      <header className="fixed top-0 inset-x-0 z-50 flex justify-center px-4 pt-3 sm:pt-4 pointer-events-none transition-all duration-300">
        <nav
          className={`pointer-events-auto flex items-center justify-between gap-3 sm:gap-6 px-4 sm:px-6 py-2.5 sm:py-3 rounded-full transition-all duration-300 max-w-5xl w-full ${
            scrolled
        ...
        >
          ...
          >
            <div className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-full overflow-hidden bg-void-800 border border-plasma/40 flex items-center justify-center p-1 group-hover:border-ember transition-colors">
              <img
                src="/logo.png"
            ...
            <div className="flex items-center gap-2">
              <span className="font-sans font-bold tracking-wider text-base sm:text-lg text-white group-hover:text-ember transition-colors whitespace-nowrap">
                ZORATH
              </span>
              <span className="inline-flex items-center text-[10px] font-mono font-medium tracking-widest text-plasma bg-plasma/10 border border-plasma/30 px-2 py-0.5 rounded-full whitespace-nowrap">
                PR-04
              </span>
            </div>
          </a>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="btn-magnetic bg-ember hover:bg-ember-600 text-white text-xs sm:text-sm font-semibold px-4 sm:px-5 py-2 sm:py-2.5 rounded-full shadow-[0_0_20px_rgba(255,87,34,0.4)] hover:shadow-[0_0_28px_rgba(255,87,34,0.7)] flex items-center gap-1.5"
            >
            ...
            <button
              ...
              className="lg:hidden p-2 text-void-100 hover:text-white rounded-full hover:bg-white/10 focus:outline-none transition-colors"
